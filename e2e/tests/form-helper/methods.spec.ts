...
test.describe('methods', () => {
  ...
  test('can submit the form using the POST method', async ({ page }) => {
  ...
  test('can submit the form using the PUT method', async ({ page }) => {
    const [request] = await Promise.all([
      page.waitForEvent('requestfinished', (request) =>
  ...
  test('can submit the form using the PATCH method', async ({ page }) => {
    const [request] = await Promise.all([
      page.waitForEvent('requestfinished', (request) =>
  ...
  test('can submit the form using the DELETE method', async ({ page }) => {
    const [request] = await Promise.all([
      page.waitForEvent('requestfinished', (request) =>
