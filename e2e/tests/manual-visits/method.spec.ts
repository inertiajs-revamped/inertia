...
test.describe('visit', () => {
  test('visits a different page', async ({ page }) => {
    ...
    await page.locator('#visits-method').click()
    await page.waitForURL('**/visits/method')
...
test.describe('method', () => {
  ...
  test('can use the visit method without any options to make a GET request', async ({
    page,
  }) => {
  ...
  test('can use the visit method with a specific "method" option to manually set the request method', async ({
    ...
    const [request] = await Promise.all([
      ...
      page.locator('#visit-specific').click(),
    ])
