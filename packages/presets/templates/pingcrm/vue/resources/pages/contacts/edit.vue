...
const props = defineProps({
  contact: {
    type: Object as PropType<PageProps['contact']>,
    required: true,
  },
  organizations: {
...
<template>
  ...
  <TrashedMessage v-if="contact.deleted_at" class="mb-6" @restore="restore"> This contact has been deleted.
  </TrashedMessage>
  <div class="max-w-3xl bg-white rounded-md shadow overflow-hidden">
    <form @submit.prevent="update">
      ...
      <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100">
        ...
        <LoadingButton :loading="form.processing" class="btn-indigo ml-auto" type="submit">Update Contact
        </LoadingButton>
      </div>
    </form>
  </div>
