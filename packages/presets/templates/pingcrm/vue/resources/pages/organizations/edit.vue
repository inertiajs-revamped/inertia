...
const props = defineProps({
  organization: {
    type: Object as PropType<PageProps['organization']>,
    required: true,
  },
})
...
<template>
  ...
  <TrashedMessage v-if="organization.deleted_at" class="mb-6" @restore="restore"> This organization has been deleted.
  </TrashedMessage>
    ...
    <form @submit.prevent="update">
      ...
      <div class="flex items-center px-8 py-4 bg-gray-50 border-t border-gray-100">
        <button v-if="!organization.deleted_at" class="text-red-600 hover:underline" tabindex="-1" type="button"
          @click="destroy">Delete Organization</button>
        <LoadingButton :loading="form.processing" class="btn-indigo ml-auto" type="submit">Update Organization
        </LoadingButton>
      </div>
    </form>
  </div>
  ...
  <div class="mt-6 bg-white rounded shadow overflow-x-auto">
    <table class="w-full whitespace-nowrap">
      ...
      <tr v-if="Array.isArray(organization.contacts) && organization.contacts.length === 0">
