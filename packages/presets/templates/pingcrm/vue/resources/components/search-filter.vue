  ...
  <div class="flex items-center">
    <div class="flex w-full bg-white rounded shadow">
      <Dropdown :auto-close="false"
        class="focus:z-10 px-4 hover:bg-gray-100 border-r focus:border-white rounded-l focus:ring md:px-6" align="left">
        <template #default>
      ...
      <input class="relative px-6 py-3 w-full rounded-r focus:outline-none focus:ring-2 focus:ring-indigo-400"
        autocomplete="off" type="text" name="search" placeholder="Search…" :value="modelValue"
